...
public class HospitalWithDoctorsPatient {
    public static void main(String[] args) {
        ...
        Hospital hospital = new Hospital("Synergy Hospital");

        
        Doctor doctor1 = new Doctor("Arpit Jain");
        Doctor doctor2 = new Doctor("Ajay Jain");

        
        Patient patient1 = new Patient("Rakesh Bhatia");
        Patient patient2 = new Patient("Sunil Sharma");
